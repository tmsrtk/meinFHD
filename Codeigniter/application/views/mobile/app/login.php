...
$submitLoginButtonAttributes = array(
	...
	'type'			=> 'submit',
	'id'			=> 'submitLoginForm',
	'value'			=> 'lokal Anmelden',
	'class'			=> 'mfhd-btn-block-primary'
);
...
<div class="row-fluid">
	<div class="well span6">
        ...
        <div class="row-fluid">
            <a href="<?php echo site_url(); ?>sso/authenticate" class="btn btn-primary btn-small pull-right">Login &uuml;ber Shibboleth</a>
        </div>
	</div>
	
	<div id="accordion-app" class="accordion span6">
