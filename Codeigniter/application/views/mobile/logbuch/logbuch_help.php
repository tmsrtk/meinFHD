        ...
        <div class="accordion" id="logbuchHelpAccordion">
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#whatIsLogbook">Was ist das Logbuch überhaupt?<i class="icon-plus pull-right"></i></h5>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#whyLogbook">Warum sollte ich das Logbuch benutzen?<i class="icon-plus pull-right"></i></h5>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#needLogbook">Muss ich das Logbuch benutzen?<i class="icon-plus pull-right"></i></h5>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#howtoCreateLogbook">Wie kann ich ein Logbuch anlegen?<i class="icon-plus pull-right"></i></h5>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#howmanyLogbooks">Kann ich beliebig viele Logbücher anlegen?<i class="icon-plus pull-right"></i></h5>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#howtoCreateEntry">Wie kann ich einen Eintrag zu einem Logbuch hinzufügen?<i class="icon-plus pull-right"></i></h5>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#whatAnalysis">Wozu dienen die Auswertungen?<i class="icon-plus pull-right"></i></h5>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h5 class="accordion-toggle" data-toggle="collapse" data-parent="#logbuchHelpAccordion" data-target="#whatAchievements">Wofür sind die Auszeichnungen?<i class="icon-plus pull-right"></i></h5>
                </div>
