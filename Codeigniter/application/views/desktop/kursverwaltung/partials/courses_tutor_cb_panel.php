<?php
    ...
    $add_tutor_button_data = array(
		...
		'content' => 'Neuen Tutor hinzuf&uuml;gen'
    );
    ...
    $submit_attributes = 'id="course-tutor-save-button-' . $course_id . '" class="btn-warning"';
...
<div class="well well-small clearfix staff-panel" id="<?php echo $panel_id_prefix.$course_id; ?>" style="display: none;">
	...
	if(!$is_tutor){
        echo '<p>Bitte w&auml;hlen Sie die Person(en) aus, die als Tutor f&uuml;r diesen Kurs vorgesehen sind und ';
        echo 'klicken Sie anschlie&szlig;end auf Speichern.';
        echo 'Sollte ein Student noch nicht als Tutor hinterlegt sein, k&ouml;nnen Sie dies &uuml;ber die ';
        echo 'Schaltfl&auml;che "Neuen Tutor hinzuf&uuml;gen" erledigen.</p>';
        echo '<hr/>';
