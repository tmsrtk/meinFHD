...
foreach ($studienplan as $semester) :
    ...
    foreach ($semester as $modul) :
        foreach ($modul as $data) :
            ...
            <?php echo '<input id="hoeren' . $data['KursID'] . '" name="hoeren_' . $data['KursID'] . '" type="hidden" value="" />'; ?>
                <?php echo '<input id="schreiben' . $data['KursID'] . '" name="hoeren_' . $data['KursID'] . '" type="hidden" value="" />'; ?>
                <h4>
                ...
                <h4>
                    <span>Note:</span>
            <?php echo '<input id="note' . $data['KursID'] . '" "name="note' . $data['KursID'] . '" type="text" class="span1 input-mini pull-right" value="' . $data['Notenpunkte'] . '">'; ?>
                </h4>
                <br />
                <h4>
                    <span>teilnehmen am:</span>
            <?php echo '<select id="semester' . $data['KursID'] . '" name="semester' . $data['KursID'] . '" class="span2">'; ?>
                    <?php
