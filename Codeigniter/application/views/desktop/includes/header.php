...
<head>
	...
	<link rel="stylesheet/less" href="<?php echo base_url(); ?>resources/bootstrap/less/bootstrap.less">
	<script src="<?php echo base_url(); ?>resources/lessjs/less-1.3.0.min.js"></script>
	<script src="<?php echo base_url(); ?>resources/bootstrap/js/jquery-1.7.2.js"></script>
	<script src="<?php echo base_url(); ?>resources/bootstrap/js/jquery-ui.js"></script>
