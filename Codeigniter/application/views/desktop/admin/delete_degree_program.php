...
<?php startblock('title');?><?php get_extended_block();?> - Studiengang l&ouml;schen<?php endblock(); ?>
...
<?php startblock('content'); # additional markup before content ?>
    <div class="row-fluid">
        <h2>Studiengang l&ouml;schen</h2>
        <p>
            Um einen Studiengang zu l&ouml;schen bitte den 'Studiengang l&ouml;schen'-Button in der
    ...
    <div class="row-fluid" id="degree_program_delete_header">
        ...
        <div class="span4"><strong>L&ouml;schen?</strong></div>
    </div>
    <div id="delete_degree_program_content">
        ...
        <?php    // general form setup
            $data_formopen = array(
                'id' => 'delete_degree_program_row'. $single_degree_program->StudiengangID, // custom id because of validation
            );


            $submit_data = array(
                'id' 			=> 'delete_degree_program_button' . $single_degree_program->StudiengangID,
                'name'			=> 'delete_degree_program_button',
                'class'			=> 'btn btn-mini btn-danger'
            );

        ?>
        <div class="row-fluid zebra-striped-div">
            <?php echo form_open('admin/delete_degree_program', $data_formopen); ?>
            ...
            <div class="span4"><?php echo form_submit($submit_data, html_entity_decode('Studiengang l&ouml;schen', ENT_COMPAT, 'UTF-8') ); ?></div>
            <?php echo form_close(); ?>
        </div>
        <?php endforeach; ?>
    </div>
...
<?php startblock('customFooterJQueryCode');?>
    ...
    $('div').on('click', '[id^=delete_degree_program_button]', function(){

        $(this).attr("data-clicked", "true");
        // show an modal for additonal user confirmation
        _showModal("Studiengang l&ouml;schen", "Soll der ausgew&auml;hlte Studiengang wirklich gel&ouml;scht werden?", true);
