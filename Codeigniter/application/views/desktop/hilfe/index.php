...
<?php
    ...
    $help[6][1] = 'Oberhalb der Tabelle der Fächer befindet sich ein hervorgehobener Bereich, in dem Deine aktuelle Durchschnittsnote, deine aktuelle Durchschnitts-Punktzahl und deine bisher erreichten Credit Points dargestellt werden.<br />Beispiel: <br />So hast du immer einen schnellen Überblick über Deinen Stand im Studium.';

?>
<div class="well well-small">
    <div class="row-fluid">
        <div class="span12">
            <h6>Detaillierte Informationen</h6>
            <h1>Hilfe</h1>
        </div>
    </div>
    <hr/>
    <div class="row-fluid">
        Auf dieser Seite sind einige Hilfestellungen zu verschiedenen Themenbereichen und Funktionen von meinFHD aufgef&uuml;hrt.
    </div>
    <br/>

    <div class="row-fluid">
        <div class="accordion" id="helpAccordion">
            <?php for ($n = 0; $n < count($help); $n++): // for each defined help topic (see above) print the accordion?>
            <div class="accordion-group">
                <div class="accordion-heading">
                    <h4 class="accordion-toggle" data-toggle="collapse" data-parent="#helpAccordion" data-target="#help_<?php echo $n; ?>"><?php echo $help[$n][0]; ?><i class="icon-plus pull-right"></i></h4>
                </div>
                <div id="help_<?php echo $n; ?>" class="accordion-body collapse">
