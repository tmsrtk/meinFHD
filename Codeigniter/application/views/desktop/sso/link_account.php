                ...
                <div id="accordion-app" class="accordion">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <h4 class="accordion-toggle" data-parent="#accordion-app" data-toggle="collapse" data-target="#request-content">Ja, ich m&ouml;chte meinen Account verkn&uuml;pfen  <i class="icon-plus pull-right"></i></h4>
                        </div>
